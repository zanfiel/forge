<!--
  ...
  Clean landing page with an "Open Folder" button.
  Shows recent projects eventually.
-->
...
<div class="welcome">
  <div class="welcome-content">
    ...
    <div class="actions">
      ...
      <button class="action-secondary" onclick={() => window.api.openExternal('https://github.com/zanfiel')}>
        <span class="action-icon">📚</span>
